...
export default function LoginPage() {
    return (
        <main className='flex justify-center content-center w-full h-screen px-32 py-8'>
            <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8">
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        ...
                        <div className="rounded-md shadow-sm -space-y-px secondary-color">
                            <div>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white event-color-bg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all"
                            >
